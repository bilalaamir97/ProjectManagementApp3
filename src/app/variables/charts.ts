...
export const chartExample22 = {
  ...
  data: {
    labels: ["bilalrock@hotmail.com", "lov@gmail.com", "junaid@gmail.com"],
    datasets: [
      {
...
export const chartExample2 = {
  ...
  data: {
    labels: ["Ammad Zaheer", "Zahid Shah", "Farhan Khan", "Ali Ur Rehman", "Shahzad Aamir", "Ammar Zafar"],
    datasets: [
      {
